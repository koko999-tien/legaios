...
function exportWorkspace(){
  const documentIndex=typeof importedDocs!=='undefined'?importedDocs.map(({blob,...meta})=>meta):[];
  const data={app:"Căn cứ Pháp lý Môi trường",schema:"ccplmt-workspace-v7",exportedAt:new Date().toISOString(),saved,recent,notes,procDone,cases,expertBriefs,complianceProfiles:complianceBackupRows(),complianceAudit:complianceAuditBackup(),documentIndex};
