...
function exportWorkspace(){
  const data={app:"Căn cứ Pháp lý Môi trường",schema:"ccplmt-workspace-v3",exportedAt:new Date().toISOString(),saved,recent,notes,procDone,cases,expertBriefs,complianceProfiles:complianceBackupRows()};
